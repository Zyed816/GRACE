...
urlpatterns = [
    ...
    path("experiments/component-ablation/create/", views.create_component_ablation_run, name="create_component_ablation"),
    path("experiments/efficiency/create/", views.create_efficiency_run, name="create_efficiency"),
    path("experiments/significance/create/", views.create_significance_run, name="create_significance"),
