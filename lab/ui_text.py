...
TEXT = {
    ...
    "charts.method_robust_score": {"zh": "方法比较 robust_score", "en": "Method Comparison robust_score"},
    "charts.violation_rate": {"zh": "violation_rate 曲线", "en": "violation_rate Curve"},
    "charts.mean_margin": {"zh": "mean_margin 曲线", "en": "mean_margin Curve"},
    "charts.sensitivity_best": {"zh": "敏感性最佳 robust_score", "en": "Sensitivity Best robust_score"},
    "charts.sensitivity_series": {"zh": "{label} 的 robust_score 变化", "en": "{label} robust_score Trend"},
    "charts.ablation_drop": {"zh": "消融平均下降", "en": "Ablation Mean Drop"},
    "charts.efficiency_train_time": {"zh": "训练总耗时", "en": "Train Total Time"},
    "charts.significance_delta": {"zh": "主比较 robust_score 差值", "en": "Primary robust_score Delta"},
